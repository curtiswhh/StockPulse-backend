...
INDEX_LIST: list[dict] = [
    ...
    {"symbol": "MOEX.ME",          "name": "Moscow Exchange MICEX-RTS",            "region": "Europe"},
    ...
    {"symbol": "^IPSA",            "name": "S&P IPSA",                             "region": "Americas"},
    {"symbol": "^MERV",            "name": "MERVAL",                               "region": "Americas"},
    {"symbol": "^TA125.TA",        "name": "TA-125",                              "region": "Middle East"},
    {"symbol": "^CASE30",          "name": "EGX 30 Price Return Index",            "region": "Africa"},
